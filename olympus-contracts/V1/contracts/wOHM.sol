...
contract wOHM is ERC20 {
    ...
    constructor( address _staking, address _OHM, address _sOHM ) ERC20( 'Wrapped sOHM', 'wsOHM' ) {
        ...
        /**
        @notice  质押OHM得到wOHM【stakes OHM and wraps sOHM】
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice 用wOHM赎回质押的OHM【unwrap sOHM and unstake OHM】
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice 用wOHM兑换sOHM【unwrap sOHM】
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice 计算指定份额wOHM价值多少sOHM【converts wOHM amount to sOHM】
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice 计算指定份额sOHM价值多少wOHM【converts sOHM amount to wOHM】
        @param _amount uint
        @return uint
     */
