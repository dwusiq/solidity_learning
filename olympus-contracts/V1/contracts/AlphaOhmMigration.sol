...
/**
 * 项目启动后，项目方要往这个合约转OHM,参与预售的用户用aOHM来兑换OHM。
 * 这个合约在githup上面没有开源。是我自己从前端找到地址然后在github上面下载的。
 */
contract AohmMigration is Ownable {
     ...
     * @notice 合约初始化
     * @param _OHM OHM合约地址
     * @param _aOHM aOHM合约地址
     * @param _swapDuration 兑换窗口开放时长（多少个区块）
     */
    function initialize(
        address _OHM,
        address _aOHM,
    ...
    /**
     * @notice 用户拿aOHM来兑换OHM
     * @param amount 兑换的aOHM份额
     */
